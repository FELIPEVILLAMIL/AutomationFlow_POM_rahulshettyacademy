...
class QueryPage():
    def __init__(self, driver):
        ...
        self.booking_information_button = (By.XPATH,'//li//a[contains(text(),"Agendamiento")]')
        #selectores para recolectar los datos después de realizar la consulta
        self.order_ActivityId=(By.XPATH,'//input[@aria-label="Id Actividad"]')
        self.order_Type=(By.XPATH,'//input[@aria-label="Tipo"]')
        self.order_ClientName=(By.XPATH,'//input[@aria-label="Nombre Completo Cliente"]')
        self.order_ClientRUT=(By.XPATH,'//input[@aria-label="Rut del Cliente"]')
        self.order_Status=(By.XPATH,'//input[@aria-label="Estado"]')
        self.order_PrimaryOwned=(By.XPATH,'//input[@aria-label="Propietario"]')
        self.order_CreatedBy = (By.XPATH,'//input[@aria-label="Creador"]')
        self.order_Reason = (By.XPATH,'//input[@aria-label="Razón"]')
        self.order_Planned = (By.XPATH,'//input[@aria-label="Fecha Inicio"]')
        self.order_PlannedEnd = (By.XPATH,'//input[@aria-label="Fecha Cierre"]')
        self.order_Channel = (By.XPATH,'//input[@aria-label="Canal"]')
        self.order_CloseCode = (By.XPATH,'//input[@aria-label="Código Cierre"]')
        self.order_Motive = (By.XPATH,'//input[@aria-label="Motivo"]')
        self.order_Description = (By.XPATH,'//input[@aria-label="Descripción"]')
        self.order_Comment = (By.XPATH,'//input[@aria-label="Comentarios"]')
